...
import { type Options, projectDeleteProjectSession, projectGetProject, projectPostProject, projectInitProject, projectPatchMasterdata, userGetUser, userPatchApiKey, sessionCreateSession, sessionPatchAccessToken, smdaGetHealth, smdaPostField, smdaPostMasterdata, healthV1HealthCheck, healthHealthCheck } from '../sdk.gen';
import { type UseMutationOptions, queryOptions } from '@tanstack/react-query';
import type { ProjectDeleteProjectSessionData, ProjectDeleteProjectSessionError, ProjectDeleteProjectSessionResponse, ProjectGetProjectData, ProjectPostProjectData, ProjectPostProjectError, ProjectPostProjectResponse, ProjectInitProjectData, ProjectInitProjectError, ProjectInitProjectResponse, ProjectPatchMasterdataData, ProjectPatchMasterdataError, ProjectPatchMasterdataResponse, UserGetUserData, UserPatchApiKeyData, UserPatchApiKeyError, UserPatchApiKeyResponse, SessionCreateSessionData, SessionCreateSessionError, SessionCreateSessionResponse, SessionPatchAccessTokenData, SessionPatchAccessTokenError, SessionPatchAccessTokenResponse, SmdaGetHealthData, SmdaPostFieldData, SmdaPostFieldError, SmdaPostFieldResponse, SmdaPostMasterdataData, SmdaPostMasterdataError, SmdaPostMasterdataResponse, HealthV1HealthCheckData, HealthHealthCheckData } from '../types.gen';
