...
import { type Options, v1DeleteProjectSession, v1GetProject, v1PostProject, v1InitProject, v1GetUser, v1PatchApiKey, v1V1HealthCheck, v1CreateSession, appHealthCheck } from '../sdk.gen';
import { type UseMutationOptions, queryOptions, type DefaultError } from '@tanstack/react-query';
import type { V1DeleteProjectSessionData, V1DeleteProjectSessionError, V1DeleteProjectSessionResponse, V1GetProjectData, V1PostProjectData, V1PostProjectError, V1PostProjectResponse, V1InitProjectData, V1InitProjectError, V1InitProjectResponse, V1GetUserData, V1PatchApiKeyData, V1PatchApiKeyResponse, V1V1HealthCheckData, V1CreateSessionData, V1CreateSessionError, V1CreateSessionResponse, AppHealthCheckData } from '../types.gen';
...
export const v1PatchApiKeyMutation = (options?: Partial<Options<V1PatchApiKeyData>>): UseMutationOptions<V1PatchApiKeyResponse, AxiosError<DefaultError>, Options<V1PatchApiKeyData>> => {
    const mutationOptions: UseMutationOptions<V1PatchApiKeyResponse, AxiosError<DefaultError>, Options<V1PatchApiKeyData>> = {
        mutationFn: async (localOptions) => {
