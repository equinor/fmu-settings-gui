...
import { type Options, v1DeleteProjectSession, v1GetProject, v1PostProject, v1InitProject, v1GetFmuDirectoryConfig, v1PatchApiTokenKey, v1V1HealthCheck, v1CreateSession, appHealthCheck } from '../sdk.gen';
import { type UseMutationOptions, queryOptions, type DefaultError } from '@tanstack/react-query';
import type { V1DeleteProjectSessionData, V1DeleteProjectSessionError, V1DeleteProjectSessionResponse, V1GetProjectData, V1PostProjectData, V1PostProjectError, V1PostProjectResponse, V1InitProjectData, V1InitProjectError, V1InitProjectResponse, V1GetFmuDirectoryConfigData, V1PatchApiTokenKeyData, V1PatchApiTokenKeyError, V1PatchApiTokenKeyResponse, V1V1HealthCheckData, V1CreateSessionData, V1CreateSessionResponse, AppHealthCheckData } from '../types.gen';
...
export const v1PatchApiTokenKeyMutation = (options?: Partial<Options<V1PatchApiTokenKeyData>>): UseMutationOptions<V1PatchApiTokenKeyResponse, AxiosError<V1PatchApiTokenKeyError>, Options<V1PatchApiTokenKeyData>> => {
    const mutationOptions: UseMutationOptions<V1PatchApiTokenKeyResponse, AxiosError<V1PatchApiTokenKeyError>, Options<V1PatchApiTokenKeyData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await v1PatchApiTokenKey({
                ...options,
                ...localOptions,
                throwOnError: true
            });
...
export const v1CreateSessionMutation = (options?: Partial<Options<V1CreateSessionData>>): UseMutationOptions<V1CreateSessionResponse, AxiosError<DefaultError>, Options<V1CreateSessionData>> => {
    const mutationOptions: UseMutationOptions<V1CreateSessionResponse, AxiosError<DefaultError>, Options<V1CreateSessionData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await v1CreateSession({
                ...options,
                ...localOptions,
