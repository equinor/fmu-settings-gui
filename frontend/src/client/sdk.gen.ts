 ...
 * RMS project path.
 */
export const projectPatchRmsProjectPath = <ThrowOnError extends boolean = false>(options: Options<ProjectPatchRmsProjectPathData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<ProjectPatchRmsProjectPathResponse, ProjectPatchRmsProjectPathError, ThrowOnError>({
        url: '/api/v1/project/rms_project_path',
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options?.headers
 ...
 */
export const sessionReadSession = <ThrowOnError extends boolean = false>(options?: Options<SessionReadSessionData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<SessionReadSessionResponse, SessionReadSessionError, ThrowOnError>({
        url: '/api/v1/session/',
        ...options
    });
};
