...
import type { V1DeleteProjectSessionData, V1DeleteProjectSessionResponse, V1DeleteProjectSessionError, V1GetProjectData, V1GetProjectResponse, V1GetProjectError, V1PostProjectData, V1PostProjectResponse, V1PostProjectError, V1InitProjectData, V1InitProjectResponse, V1InitProjectError, V1GetUserData, V1GetUserResponse, V1GetUserError, V1PatchApiKeyData, V1PatchApiKeyResponse, V1V1HealthCheckData, V1V1HealthCheckResponse, V1V1HealthCheckError, V1CreateSessionData, V1CreateSessionResponse, V1CreateSessionError, AppHealthCheckData, AppHealthCheckResponse } from './types.gen';
...
export const v1PatchApiKey = <ThrowOnError extends boolean = false>(options: Options<V1PatchApiKeyData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<V1PatchApiKeyResponse, unknown, ThrowOnError>({
