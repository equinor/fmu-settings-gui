 ...
 * the Sumo platform.
 */
export const projectGetSumoAssets = <ThrowOnError extends boolean = false>(options?: Options<ProjectGetSumoAssetsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ProjectGetSumoAssetsResponse, unknown, ThrowOnError>({
...
export const projectPostInitProject = <ThrowOnError extends boolean = false>(options: Options<ProjectPostInitProjectData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ProjectPostInitProjectResponse, unknown, ThrowOnError>({
 ...
 */
export const projectPostLockRelease = <ThrowOnError extends boolean = false>(options?: Options<ProjectPostLockReleaseData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<ProjectPostLockReleaseResponse, ProjectPostLockReleaseError, ThrowOnError>({
 ...
 */
export const projectPostValidateMasterdataSmda = <ThrowOnError extends boolean = false>(options?: Options<ProjectPostValidateMasterdataSmdaData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<ProjectPostValidateMasterdataSmdaResponse, unknown, ThrowOnError>({
 ...
 */
export const projectPatchCacheMaxRevisions = <ThrowOnError extends boolean = false>(options: Options<ProjectPatchCacheMaxRevisionsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<ProjectPatchCacheMaxRevisionsResponse, ProjectPatchCacheMaxRevisionsError, ThrowOnError>({
 ...
 */
export const projectGetRestoreCheck = <ThrowOnError extends boolean = false>(options?: Options<ProjectGetRestoreCheckData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ProjectGetRestoreCheckResponse, ProjectGetRestoreCheckError, ThrowOnError>({
 ...
 */
export const projectPostRestore = <ThrowOnError extends boolean = false>(options?: Options<ProjectPostRestoreData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<ProjectPostRestoreResponse, ProjectPostRestoreError, ThrowOnError>({
 ...
 */
export const projectPostMappingsImportRmsEclipseCsv = <ThrowOnError extends boolean = false>(options?: Options<ProjectPostMappingsImportRmsEclipseCsvData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<ProjectPostMappingsImportRmsEclipseCsvResponse, unknown, ThrowOnError>({
 ...
 */
export const projectPostMappingsExportRmsSimulatorRenamingTable = <ThrowOnError extends boolean = false>(options?: Options<ProjectPostMappingsExportRmsSimulatorRenamingTableData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<ProjectPostMappingsExportRmsSimulatorRenamingTableResponse, unknown, ThrowOnError>({
 ...
 */
export const projectGetChangelog = <ThrowOnError extends boolean = false>(options?: Options<ProjectGetChangelogData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ProjectGetChangelogResponse, unknown, ThrowOnError>({
 ...
 */
export const sessionGetRestoreCheck = <ThrowOnError extends boolean = false>(options?: Options<SessionGetRestoreCheckData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<SessionGetRestoreCheckResponse, SessionGetRestoreCheckError, ThrowOnError>({
 ...
 */
export const smdaPostWellHeaders = <ThrowOnError extends boolean = false>(options: Options<SmdaPostWellHeadersData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<SmdaPostWellHeadersResponse, unknown, ThrowOnError>({
 ...
 * - 'low': score < 50
 */
export const matchPostMatch = <ThrowOnError extends boolean = false>(options: Options<MatchPostMatchData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<MatchPostMatchResponse, unknown, ThrowOnError>({
        url: '/api/v1/match',
        ...options,
        headers: {
            'Content-Type': 'application/json',
